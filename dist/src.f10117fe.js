...
exports.Attributes = Attributes; //K is name age or ID T is type User Props
...
exports.Collection = Collection; //K is User Props or a generic
...
exports.User = User; //anytime we want to create a user we will
